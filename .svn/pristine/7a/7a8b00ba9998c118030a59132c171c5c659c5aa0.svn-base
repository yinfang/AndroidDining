...
public class GetMemberInfoByMemNoNew extends OPBase {

    public GetMemberInfoByMemNoNew(Context context) {
        super(context);
    }
    ...
    public Result execute(Object... args) throws Exception {
        MyRow row = new MyRow();
        row.put("strMemNo", args[0]);
        Object obj = operate("GetMemberInfoByMemNoNew", row);
