...
/**
 * Created by long on 17-5-5.
 */

public class GetKitchenType extends OPBase {
    public GetKitchenType(Context context) {
        super(context);
    }
    ...
    public Result execute(Object... args) throws Exception {
        MyRow row = new MyRow();
        row.put("criteria", args[1]);
        Object obj = operate("GetKitchenType", row);
