...
public class GetRecommendDish extends OPBase {

	public GetRecommendDish(Context context) {
		super(context);
	}
	...
	public Result execute(Object... args) throws Exception {
		...
		row.put("category", args[1]);
		row.put("queryDate", args[2]);
		Object obj = operate("GetRecommendDish", row);
