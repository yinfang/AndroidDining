...
//import com.clubank.device.ImageGridActivity;
...
public class Utils {
     ...
     * 微信支付工具相关
     */
    private static final String TAG = "SDK_app.Util";
    ...
    private static class SSLSocketFactoryEx extends SSLSocketFactory {
        ...
        public SSLSocketFactoryEx(KeyStore truststore) throws NoSuchAlgorithmException, KeyManagementException,
            ...
            TrustManager tm = new X509TrustManager() {
                ...
                @Override
                public void checkClientTrusted(X509Certificate[] chain, String authType) throws java.security.cert
						.CertificateException {
                }

                @Override
                public void checkServerTrusted(X509Certificate[] chain, String authType) throws java.security.cert
						.CertificateException {
                }
            };
