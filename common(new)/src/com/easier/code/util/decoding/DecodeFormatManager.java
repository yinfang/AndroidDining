...
package com.easier.code.util.decoding;
...
final class DecodeFormatManager {
	...
	static {
		...
		ONE_D_FORMATS = new Vector<BarcodeFormat>(PRODUCT_FORMATS.size() + 7);
		...
		DATA_MATRIX_FORMATS = new Vector<BarcodeFormat>(2);
		DATA_MATRIX_FORMATS.add(BarcodeFormat.DATA_MATRIX);
		DATA_MATRIX_FORMATS.add(BarcodeFormat.MAXICODE);
