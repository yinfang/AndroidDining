...
public abstract class ImageWorker {
	...
	public void loadImage(Object data, ImageView imageView,
			boolean downloadImageOn2G3G, boolean showWaiting,
		...
		if (bitmap != null) {
			...
			imageView.setImageBitmap(bitmap);
				...
				&& (U.isWifi(imageView.getContext()) || downloadImageOn2G3G)) {
			final BitmapWorkerTask task = new BitmapWorkerTask(imageView,
					showWaiting);
			if (loadingImageUrl == null && mLoadingBitmap == null) {
				mLoadingBitmap = defaultLoadingBitmap;
			}
			if (loadingImageUrl != null) {
				Bitmap bmp = mImageCache
						.getBitmapFromDiskCache(loadingImageUrl);
				if (bmp != null) {
					mLoadingBitmap = bmp;
				}
			}
	...
	// added by chenyh 2014-07-14
	public Bitmap getBitmapFromDiskCache(String id) {
		return mImageCache.getBitmapFromDiskCache(id);
	}
	...
	private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
		...
		public BitmapWorkerTask(ImageView imageView, boolean showWaiting) {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			if (showWaiting) {
				wd = new WaitingDialog(imageView.getContext());
				wd.show();
			}
		}
