...
public class MyDateDialog {
	...
	public void show(int year, int month, int day,boolean showday) {
	 ...
	 * @param showDay
	 */
	public void show(int year, int month, int day,boolean showYear,boolean showMonth,boolean showDay) {
